...
var date = document.querySelector('.degree > h6');
var country = document.querySelector('.place > h2');
var place = document.querySelector('.place > h6');
var weatherStatus = document.querySelector('.weather-status > h6');
var feelsLike = document.querySelector('.weather-details > div:nth-child(1) > h5 > span');
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/search-icon-white.svg */ "./src/assets/search-icon-white.svg"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Inter:wght@500;600&display=swap);"]);
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*, *::before, *::after {\n  box-sizing: border-box;\n  padding: 0;\n}\n\nbody {\n  background-color: #6368A6;\n  font-family: \"Inter\", sans-serif;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  margin: 0;\n  padding: 20px;\n  color: #ffffff;\n  font-size: 1vw;\n}\n\n.weather-container {\n  position: relative;\n  max-width: 782px;\n  height: auto;\n  font-size: 1em;\n  overflow: hidden;\n}\n\n.circle {\n  position: absolute;\n  margin-top: -100%;\n  width: 400px;\n  height: 400px;\n  background-color: #F8A018;\n}\n\n.search-wrapper {\n  width: 100%;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 30px;\n}\n.search-wrapper div {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\ninput {\n  background-color: transparent;\n  border-bottom: 1px #F8A018 solid;\n  border-top: none;\n  border-left: none;\n  border-right: none;\n  font-size: 1.2rem;\n  width: 25em;\n  height: 32px;\n  color: white;\n  padding: 8px 8px 8px 8px;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-size: 0.8em 0.8em;\n  background-repeat: no-repeat;\n  background-position-x: 24px;\n  background-position-y: 2px;\n  margin-top: 32px;\n}\n\ninput:focus-visible {\n  outline: none;\n  box-sizing: border-box;\n  background-color: transparent;\n  border-bottom: 1px #F8A018 solid;\n  margin-top: 24px;\n  height: 40px;\n  color: white;\n  font-size: 1.2rem;\n  padding: 8px 8px 8px 8px;\n  background-image: none;\n  border-top: none;\n  border-left: none;\n  border-right: none;\n}\n\nh1 {\n  font-size: 12.5em;\n  font-weight: 600;\n  margin: -10px 0 0 0;\n}\n\nh2 {\n  font-size: 9.375em;\n  font-weight: 600;\n  margin: 0;\n}\n\nh5 {\n  font-size: 3.004375em;\n  font-weight: 500;\n  margin: 20px 0 0 0;\n}\n\nh6 {\n  font-size: 1.953125em;\n  font-weight: 500;\n  margin: 0;\n}\n\n.weather-details {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  border-top: 1px solid #F8A018;\n  padding-top: 20px;\n}\n.weather-details div {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\nimg {\n  width: 60px;\n}\n\n.degree {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  margin-top: -20px;\n}\n\n.place {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: flex-end;\n}\n\n.weather-status {\n  margin-top: 10px;\n}\n\n@media screen and (max-width: 425px) {\n  .weather-container {\n    position: relative;\n    max-width: 400px;\n    height: auto;\n    font-size: 1em;\n    overflow: hidden;\n  }\n  .search-wrapper {\n    margin-bottom: 30px;\n  }\n  input {\n    width: 90%;\n  }\n  input:focus {\n    width: 90%;\n  }\n  h1 {\n    font-size: 12.5em;\n    font-weight: 600;\n    margin: 0 0 0 0;\n  }\n  img {\n    width: 40px;\n  }\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAMA;EACE,sBAAA;EACA,UAAA;AAJF;;AAOA;EACE,yBAVc;EAWd,gCAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,aAAA;EACA,SAAA;EACA,aAAA;EACA,cAjBY;EAkBZ,cAAA;AAJF;;AAQA;EACE,kBAAA;EACA,gBAAA;EACA,YAAA;EACA,cAAA;EACA,gBAAA;AALF;;AAQA;EACE,kBAAA;EACA,iBAAA;EACA,YAAA;EACA,aAAA;EACA,yBApCgB;AA+BlB;;AAQA;EACE,WAAA;EACA,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;AALF;AAOE;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;AALJ;;AASA;EACE,6BAAA;EACA,gCAAA;EACA,gBAAA;EACA,iBAAA;EACA,kBAAA;EACA,iBAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,wBAAA;EACA,yDAAA;EACA,4BAAA;EACA,4BAAA;EACA,2BAAA;EACA,0BAAA;EACA,gBAAA;AANF;;AASA;EACA,aAAA;EACA,sBAAA;EACA,6BAAA;EACA,gCAAA;EACA,gBAAA;EACA,YAAA;EACA,YAAA;EACA,iBAAA;EACA,wBAAA;EACA,sBAAA;EACA,gBAAA;EACA,iBAAA;EACA,kBAAA;AANA;;AASA;EACE,iBAAA;EACA,gBAAA;EACA,mBAAA;AANF;;AASA;EACE,kBAAA;EACA,gBAAA;EACA,SAAA;AANF;;AASA;EACE,qBAAA;EACA,gBAAA;EACA,kBAAA;AANF;;AASA;EACE,qBAAA;EACA,gBAAA;EACA,SAAA;AANF;;AASA;EACE,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,6BAAA;EACA,iBAAA;AANF;AAQE;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;AANJ;;AAUA;EACE,WAAA;AAPF;;AAUA;EACE,aAAA;EACA,sBAAA;EACA,2BAAA;EACA,iBAAA;AAPF;;AAWA;EACE,WAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,qBAAA;AARF;;AAWA;EACE,gBAAA;AARF;;AAYA;EAEE;IACE,kBAAA;IACA,gBAAA;IACA,YAAA;IACA,cAAA;IACA,gBAAA;EAVF;EAYF;IACE,mBAAA;EAVA;EAYA;IACE,UAAA;EAVF;EAaA;IACE,UAAA;EAXF;EAcA;IACE,iBAAA;IACA,gBAAA;IACA,eAAA;EAZF;EAeA;IACE,WAAA;EAbF;AACF","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Inter:wght@500;600&display=swap');\n\n$primary-color: #6368A6;\n$secondary-color: #F8A018;\n$white-color: #ffffff;\n\n*,*::before,*::after {\n  box-sizing: border-box;\n  padding: 0;\n}\n\nbody {\n  background-color: $primary-color;\n  font-family: 'Inter', sans-serif;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  margin: 0;\n  padding: 20px;\n  color: $white-color;\n  font-size: 1vw;\n}\n\n\n.weather-container {\n  position: relative;\n  max-width: 782px;\n  height: auto;\n  font-size: 1em;\n  overflow: hidden;\n}\n\n.circle {\n  position: absolute;\n  margin-top: -100%;\n  width: 400px;\n  height: 400px;\n  background-color: $secondary-color;\n}\n\n.search-wrapper {\n  width: 100%;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 30px;\n\n  div {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n  }\n}\n\ninput {\n  background-color: transparent;\n  border-bottom: 1px $secondary-color solid;\n  border-top: none;\n  border-left: none;\n  border-right: none;\n  font-size: 1.2rem;\n  width: 25em;\n  height: 32px;\n  color: white;\n  padding: 8px 8px 8px 8px;\n  background-image: url(../assets/search-icon-white.svg);\n  background-size: 0.8em 0.8em;\n  background-repeat: no-repeat;\n  background-position-x: 24px;\n  background-position-y: 2px;\n  margin-top: 32px;\n}\n\ninput:focus-visible {\noutline: none;\nbox-sizing: border-box;\nbackground-color: transparent;\nborder-bottom: 1px $secondary-color solid;\nmargin-top: 24px;\nheight: 40px;\ncolor: white;\nfont-size: 1.2rem;\npadding: 8px 8px 8px 8px;\nbackground-image: none;\nborder-top: none;\nborder-left: none;\nborder-right: none;\n}\n\nh1 {\n  font-size: 12.5em;\n  font-weight: 600;\n  margin: -10px 0 0 0;\n}\n\nh2 {\n  font-size: 9.375em;\n  font-weight: 600;\n  margin: 0;\n}\n\nh5 {\n  font-size: 3.004375em;\n  font-weight: 500;\n  margin: 20px 0 0 0;\n}\n\nh6{\n  font-size: 1.953125em;\n  font-weight: 500;\n  margin: 0;\n}\n\n.weather-details {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  border-top: 1px solid $secondary-color;\n  padding-top: 20px;\n\n  div {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n  }\n}\n\nimg {\n  width: 60px;\n}\n\n.degree {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  margin-top: -20px;\n\n}\n\n.place {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: flex-end;\n}\n\n.weather-status {\n  margin-top: 10px;\n\n}\n\n@media screen and (max-width: 425px) {\n\n  .weather-container {\n    position: relative;\n    max-width: 400px;\n    height: auto;\n    font-size: 1em;\n    overflow: hidden;\n  }\n.search-wrapper {\n  margin-bottom: 30px;\n}\n  input {\n    width: 90%;\n  }\n\n  input:focus {\n    width: 90%;\n  }\n  \n  h1 {\n    font-size: 12.5em;\n    font-weight: 600;\n    margin: 0 0 0 0;\n  }\n\n  img {\n    width: 40px;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
module.exports = __webpack_require__.p + "search-icon-white.svg";
